...
public class Student {
    ...
    public Student(String name, Integer age, double[] scoreArr, List<Course> courseList, Set<String> friendSet, Map countriesMap, Properties properties) {
        this.name = name;
        this.age = age;
